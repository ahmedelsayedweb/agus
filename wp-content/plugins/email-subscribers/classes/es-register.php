			...
			<form class="es_widget_form" data-es_form_id="es_widget_form">
				...
				<?php if( $es_name == "YES" ) { ?>
					<div class="es_lablebox">
						<label class="es_widget_form_name"><?php echo __( 'Name', ES_TDOMAIN ); ?>
						</label>
					</div>
				...
				<form class="footer-form">
                      <input type="text" id="es_txt_email" name="es_txt_email" placeholder="Enter Your Email ..." class="footer-form__input" onkeypress="if(event.keyCode==13) es_submit_page(event,'<?php echo $url; ?>')" value="" maxlength="225">
